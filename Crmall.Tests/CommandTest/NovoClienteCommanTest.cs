...
namespace Crmall.Tests.CommandTest
{
    public class NovoClienteCommanTest
    {
        ...
        {
            //Arrange
            var command = new NovoClienteCommand("", DateTime.Now, ESexo.Feminino);
        ...
        {
            //Arrange
            var command = new NovoClienteCommand("Murilo Sanches", DateTime.Now.AddYears(-200), ESexo.Feminino);
        ...
        {
            //Arrange
            var command = new NovoClienteCommand("Murilo Sanches", DateTime.Now, ESexo.Feminino, "87055-80");
        ...
        {
            //Arrange
            var command = new NovoClienteCommand("Murilo Sanches", DateTime.Now, ESexo.Feminino, "87055-280");
